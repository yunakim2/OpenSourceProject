...
# !wget https://github.com/yunakim2/OpenSourceProject/raw/feat/kobart/data/labeled/samsung_2010_2021.csv
...
print('Model Created')
#%%
data = pd.read_csv('samsung_2010_2021.csv', encoding='utf-8', dtype={'label':np.float32})
